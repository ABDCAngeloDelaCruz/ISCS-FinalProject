...
namespace FinalProject
{
    public partial class newPosts : UserControl
    {
        ...
        public void LoadPosts()
        {
            ...
            // Add a debug label to show we're in the LoadPosts method
            ...
            postContainer.Controls.Add(debugLabel);

            // Make sure the debug label is visible
            ...
            try
            {
                ...
                // Update debug label with post count
                debugLabel.Text = $"Found {posts?.Count ?? 0} posts in XML file.";
